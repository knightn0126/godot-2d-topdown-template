...
@export var max_speed = 500.0 ## The maximum speed the entity can reach while moving.
@export var friction = 10000.0 ## Affects the time it takes for the entity to reach max_speed or to stop.
